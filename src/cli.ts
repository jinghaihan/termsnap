...
try {
  ...
  cli
    ...
    .option('--typed-speed <typed-speed>', 'Typing speed in milliseconds per character')
    .option('--typed-initial-delay <typed-initial-delay>', 'Initial delay before starting to type')
    .option('--typed-pause-after <typed-pause-after>', 'Pause after typing completes')
